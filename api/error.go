...
var (
	MessageErr map[int]string = map[int]string{
		...
		// profile
		200: "Введен не верный текущий пароль",
		201: "Пароль не совпадает",
		202: "Введен не верный текущий пароль",
		203: "Ошибка шифрования пароля",
		204: "Ошибка применения пароля",
		205: "Не корретный пароль",

		401: "Пользователь не авторизован",
		404: "Страница не найдена",
		408: "Время выполнения истекло",
		...
		// player
		1400: "Ошибка в теле запроса",
		1401: "Не корректная дата рождения",
		1402: "Не корректная дата рождения",
	}
)
